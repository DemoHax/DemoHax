...
@SearchTags({"demohax logo", "top left corner"})
@DontBlock
public final class WurstLogoOtf extends OtherFeature
{
	private final EnumSetting<Visibility> visibility =
		new EnumSetting<>("Visibility", Visibility.values(), Visibility.ENABLED);
	
	public WurstLogoOtf()
	{
		super("DemoHaxLogo", "Shows the DemoHax logo on the screen.");
