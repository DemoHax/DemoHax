...
public class WurstOptionsScreen extends Screen
{
	...
	private void addLinkButtons()
	{
		...
		new WurstOptionsButton(54, 24, () -> "Official Website",
			"DemoHax.github.io", b -> os.open("https://demohax.github.io/"));
		
		new WurstOptionsButton(54, 48, () -> "Twitter", "@DemoHax",
			b -> os.open("https://twitter.com/DemoHax"));
	...
	private void renderTitles(MatrixStack matrixStack)
	{
		...
		drawCenteredString(matrixStack, tr, "DemoHax Options", middleX, y1,
			0xffffff);
